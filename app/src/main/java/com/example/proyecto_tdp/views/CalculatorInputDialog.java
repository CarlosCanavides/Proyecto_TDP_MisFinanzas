...
public class CalculatorInputDialog extends AlertDialog.Builder implements View.OnClickListener{
    ...
    private void initComponents() {
        valueEditText = dialog.findViewById(R.id.calculator_value);
        currencyTextView = dialog.findViewById(R.id.calculator_currency);
        backspaceButtun = dialog.findViewById(R.id.calculator_backspace);
        nineButton= dialog.findViewById(R.id.calculator_9);
        eightButton= dialog.findViewById(R.id.calculator_8);
        sevenButton= dialog.findViewById(R.id.calculator_7);
        sixButton= dialog.findViewById(R.id.calculator_6);
        fiveButton= dialog.findViewById(R.id.calculator_5);
        fourButton= dialog.findViewById(R.id.calculator_4);
        threeButton= dialog.findViewById(R.id.calculator_3);
        twoButton= dialog.findViewById(R.id.calculator_2);
        oneButton= dialog.findViewById(R.id.calculator_1);
        zeroButton= dialog.findViewById(R.id.calculator_0);
        clearButton = dialog.findViewById(R.id.calculator_ce);
        dotButton= dialog.findViewById(R.id.calculator_dot);
