...
public class CalendarioDialog extends DialogFragment implements android.app.DatePickerDialog.OnDateSetListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(getClass().getName(), "Error al alterar label el datePicker", e);
        }
        return dialog;
    }
...
//        }
    ...
    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
        try {
            ...
            Log.e(getClass().getName(), "Error en el atributo data.", e);
        }
    }
